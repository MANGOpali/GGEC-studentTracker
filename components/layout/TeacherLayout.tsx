    ...
    <div className="min-h-screen bg-slate-100">
      <header className="sticky top-0 z-50 bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 h-16 flex items-center gap-4">
          <Link href="/teacher/dashboard" className="flex-shrink-0 mr-2">
      ...
      <Link href="/teacher/leads/new" className="fixed bottom-6 right-6 z-40 lg:hidden bg-blue-600 text-white rounded-full w-14 h-14 flex items-center justify-center shadow-lg hover:bg-blue-700 transition-colors">
        <UserPlus size={22} />
      </Link>
    </div>
  );
